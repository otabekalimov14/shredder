...
export default function TextInput({ onExtract, loading }: TextInputProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Section Header */}
      <div>
        <h2 className="text-xl font-semibold text-black mb-2">Step 1: Input</h2>
        <p className="text-gray-600">Paste syllabus text or upload a file for processing.</p>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full h-64 p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black resize-none"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-6 py-3 bg-black text-white font-semibold rounded-md hover:bg-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
        ...
        <div className="space-y-4">
          <div className="border-2 border-dashed border-gray-300 rounded-md p-8 text-center">
            ...
            <label htmlFor="file-input" className="cursor-pointer">
              ...
              <p className="text-sm text-gray-500">PDF, DOCX, PNG, JPG, or TXT (max 10MB)</p>
            </label>
          </div>
